...
export const BINGO_GROUPS: CardData = {
  B: [
    ...
    { id: 107, name: 'Búho', imageUrl: '/imagenes/animalitos/Buho.png' },
    ...
    { id: 112, name: 'Delfín', imageUrl: '/imagenes/animalitos/Delfin.png' },
  ...
  I: [
    ...
    { id: 208, name: 'Halcón', imageUrl: '/imagenes/animalitos/Halcon.png' },
    { id: 209, name: 'Hámster', imageUrl: '/imagenes/animalitos/Hamster.png' },
    { id: 210, name: 'Hiena', imageUrl: '/imagenes/animalitos/Hiena.png' },
    { id: 211, name: 'Hipopótamo', imageUrl: '/imagenes/animalitos/Hipopotamo.png' },
  ...
  N: [
    ...
    { id: 301, name: 'Lémur', imageUrl: '/imagenes/animalitos/Lemur.png' },
    { id: 302, name: 'León', imageUrl: '/imagenes/animalitos/Leon.png' },
    ...
    { id: 309, name: 'Murciélago', imageUrl: '/imagenes/animalitos/Murcielago.png' },
    ...
    { id: 320, name: 'Pingüino', imageUrl: '/imagenes/animalitos/Pinguino.png' },
  ...
  G: [
    ...
    { id: 402, name: 'Ratón', imageUrl: '/imagenes/animalitos/Raton.png' },
    ...
    { id: 411, name: 'Tucán', imageUrl: '/imagenes/animalitos/Tucan.png' },
    // Alimentos para columna G (Q-T)
    { id: 412, name: 'Queso', imageUrl: '/imagenes/alimentos/Queso.png' },
    { id: 413, name: 'Rúcula', imageUrl: '/imagenes/alimentos/Rucula.png' },
    { id: 414, name: 'Sandía', imageUrl: '/imagenes/alimentos/Sandia.png' },
